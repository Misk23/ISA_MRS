...
insert into user (username,password, dtype,name, last_name, email) values ('misk', '$2a$04$Amda.Gm4Q.ZbXz9wcohDHOhOBaNQAkSS1QO26Eh8Hovu3uzEpQvcq','Admin','Mihajlo', 'Jovkovic', 'mihajlo.jovkovic@gmail.com');
